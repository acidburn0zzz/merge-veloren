...
impl Animation for IdleAnimation {
    ...
    fn update_skeleton_inner(
        ...
        let short1 = (anim_time as f32 * lab as f32 * 4.0).sin();
        let short2 = (anim_time as f32 * lab as f32 * 4.0 + PI * 0.1).sin();
        let short3 = (anim_time as f32 * lab as f32 * 4.0 + PI * 0.2).sin();
        let short4 = (anim_time as f32 * lab as f32 * 4.0 + PI * 0.3).sin();
        let short5 = (anim_time as f32 * lab as f32 * 4.0 + PI * 0.4).sin();
        ...
        next.body_2.scale = Vec3::one() - short4.abs() / 7.8;
        ...
        next.body_3.scale = Vec3::one() - short3.abs() / 7.6;
        ...
        next.body_4.scale = Vec3::one() - short2.abs() / 7.4;
        ...
        next.body_5.scale = Vec3::one() - short1.abs() / 7.2;

        next.tail_upper.position = Vec3::new(0.0, skeleton_attr.tail_upper.0 - 12.0, skeleton_attr.tail_upper.1);
        next.tail_upper.orientation = Quaternion::rotation_z(0.0);
        next.tail_upper.scale = Vec3::one() - short2 / 7.0;

        next.tail_lower.position = Vec3::new(0.0, skeleton_attr.tail_lower.0 - 8.0, skeleton_attr.tail_lower.1);
        next.tail_lower.orientation = Quaternion::rotation_z(0.0);
        next.tail_lower.scale = Vec3::one() - short3 / 10.0;
