...
impl<'a> Renderer<'a> {
    ...
    //     &mut self,
    //     model: &Model<lod_terrain::Vertex>,
    //     global: &GlobalModel,
    //     lod: &lod_terrain::LodData,
    // ) {
    //     self.encoder.draw(
    ...
    //     &mut self,
    //     model: &Model<postprocess::Vertex>,
    //     globals: &Consts<Globals>,
    // ) {
    //     self.encoder.draw(
    //         &gfx::Slice {
