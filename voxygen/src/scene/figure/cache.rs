    ...
    fn from(cs: Option<&CharacterState>, camera_mode: CameraMode, loadout: &Loadout) -> Self {
        ...
        Self {
            ...
            third_person: if is_first_person {
                ...
                Some(CharacterThirdPersonKey {
                    shoulder: if let Some(ItemKind::Armor(Armor {
                        ...
                        ..
                    })) = loadout.shoulder.as_ref().map(|i| &i.item_def.kind)
                    {
                        Some(armor.clone())
                    } else {
                        None
                    ...
                    chest: if let Some(ItemKind::Armor(Armor {
                        ...
                        ..
                    })) = loadout.chest.as_ref().map(|i| &i.item_def.kind)
                    {
                        Some(armor.clone())
                    } else {
                        None
                    ...
                    belt: if let Some(ItemKind::Armor(Armor {
                        ...
                        ..
                    })) = loadout.belt.as_ref().map(|i| &i.item_def.kind)
                    {
                        Some(armor.clone())
                    } else {
                        None
                    ...
                    back: if let Some(ItemKind::Armor(Armor {
                        ...
                        ..
                    })) = loadout.back.as_ref().map(|i| &i.item_def.kind)
                    {
                        Some(armor.clone())
                    } else {
                        None
                    ...
                    pants: if let Some(ItemKind::Armor(Armor {
                        ...
                        ..
                    })) = loadout.pants.as_ref().map(|i| &i.item_def.kind)
                    {
                        Some(armor.clone())
                    } else {
                        None
            ...
            lantern: if let Some(ItemKind::Lantern(lantern)) =
                loadout.lantern.as_ref().map(|i| &i.item_def.kind)
            {
            ...
            hand: if let Some(ItemKind::Armor(Armor {
                ...
                ..
            })) = loadout.hand.as_ref().map(|i| &i.item_def.kind)
            {
                Some(armor.clone())
            } else {
                None
            ...
            foot: if let Some(ItemKind::Armor(Armor {
                ...
                ..
            })) = loadout.foot.as_ref().map(|i| &i.item_def.kind)
            {
                Some(armor.clone())
            } else {
                None
