    ...
    pub fn get_abilities(&self) -> Vec<CharacterAbility> {
        ...
        match &self.kind {
            ...
            Axe(_) => vec![
                ...
                LeapMelee {
                    energy_cost: tweak!(300),
                    movement_duration: Duration::from_millis(tweak!(200)),
                    buildup_duration: Duration::from_millis(tweak!(1000)),
                    recover_duration: Duration::from_millis(tweak!(600)),
                    base_damage: (tweak!(170.0) * self.base_power()) as u32,
                    range: tweak!(3.5),
                    max_angle: tweak!(50.0),
                    leap_speed: tweak!(20.0),
            ...
            Hammer(_) => vec![
                ...
                ChargedMelee {
                    ...
                    max_damage: (tweak!(170.0) * self.base_power()) as u32,
                    initial_knockback: tweak!(12.0),
                    max_knockback: tweak!(60.0),
                    prepare_duration: Duration::from_millis(tweak!(200)),
                    charge_duration: Duration::from_millis(tweak!(1200)),
                    recover_duration: Duration::from_millis(tweak!(500)),
                    range: tweak!(3.5),
                    max_angle: tweak!(30.0),
                },
                LeapMelee {
            ...
            Bow(_) => vec![
                ...
                RepeaterRanged {
                    ...
                    holdable: true,
                    movement_duration: Duration::from_millis(tweak!(200)),
                    prepare_duration: Duration::from_millis(tweak!(1000)),
                    recover_duration: Duration::from_millis(tweak!(1000)),
                    projectile: Projectile {
                        hit_solid: vec![projectile::Effect::Stick],
                        hit_entity: vec![
                            projectile::Effect::Damage((-40.0 * self.base_power()) as i32),
