        ...
        match &self.kind {
            ...
            Dagger(_) => vec![
                ComboMelee {
                    stage_data: vec![
                        combo_melee::Stage {
                            ...
                            max_damage: (40.0 * self.base_power()) as u32,
                            damage_increase: (15.0 * self.base_power()) as u32,
                            knockback: 0.0,
                            range: 3.5,
                            angle: 30.0,
                            base_buildup_duration: Duration::from_millis(75),
                            base_swing_duration: Duration::from_millis(100),
                            base_recover_duration: Duration::from_millis(1),
                            forward_movement: 0.0,
                            auto_continue: true,
                        },
                        combo_melee::Stage {
                            ...
                            range: 3.5,
                            angle: 30.0,
                            base_buildup_duration: Duration::from_millis(1),
                            base_swing_duration: Duration::from_millis(100),
                            base_recover_duration: Duration::from_millis(1),
                            forward_movement: 0.0,
                            auto_continue: true,
                        ...
                        combo_melee::Stage {
                            ...
                            max_damage: (60.0 * self.base_power()) as u32,
                            damage_increase: (20.0 * self.base_power()) as u32,
                            knockback: 20.0,
                            range: 6.0,
                            angle: 10.0,
                            base_buildup_duration: Duration::from_millis(1),
                            base_swing_duration: Duration::from_millis(100),
                            base_recover_duration: Duration::from_millis(75),
                            forward_movement: 0.0,
                            auto_continue: false,
                        },
                    ],
                ...
                DashMelee {
                    ...
                    charge_duration: Duration::from_millis(300),
                    swing_duration: Duration::from_millis(100),
                    recover_duration: Duration::from_millis(300),
